...
echo -e "export BASE_RELEASE_TAG=${RELEASETAG}" >> '/etc/image-build-info'
...
pacman -S base which awk sed grep gzip supervisor nano vi ldns moreutils bind-tools net-tools dos2unix unzip unrar htop jq openssl-1.1 openbsd-netcat rsync --noconfirm
